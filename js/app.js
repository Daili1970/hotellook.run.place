...
/* set links address */
    docReady(function()
    {
        var href = "https://www.hotellook.ru/?marker=" + marker +'._landings';
        ...
        var hrefitem0 = "https://hotellook.ru/cities/moscow?marker=" + marker +'._landings';
        logo2.setAttribute('href', href);
        var hrefitem1 = "https://hotellook.ru/cities/phuket-island?marker=" + marker +'._landings';
        var hrefitem2 = "https://hotellook.ru/cities/st-petersburg?marker=" + marker +'._landings';
        var hrefitem3 = "https://hotellook.ru/cities/prague?marker=" + marker +'._landings';
        var hrefitem4 = "https://hotellook.ru/cities/sochi?marker=" + marker +'._landings';
        var hrefitem5 = "https://hotellook.ru/cities/barcelona?marker=" + marker +'._landings';
        var hrefitem6 = "https://hotellook.ru/cities/jalta?marker=" + marker +'._landings';

        carouselItems[0].setAttribute('href', hrefitem0);
        carouselItems[1].setAttribute('href', hrefitem1);
        carouselItems[2].setAttribute('href', hrefitem2);
        carouselItems[3].setAttribute('href', hrefitem3);
        carouselItems[4].setAttribute('href', hrefitem4);
        carouselItems[5].setAttribute('href', hrefitem5);
        carouselItems[6].setAttribute('href', hrefitem6);
        /*
         for (var i = 0; i < carouselItems.length; i++)
         {
         carouselItems[i].setAttribute('href', href);
         } */
    });
/* set links address */